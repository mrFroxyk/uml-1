...
public class Main {
  ...
  private static void addMagazine() {
    ...
    int issueNumber = readIntInput();
    publications.add(new Magazine(title, year, pages, language, issueNumber));
  ...
  private static void addBook() {
    ...
    publications.add(new Book(title, year, pages, language, author));
  ...
  private static void addTextbook() {
    System.out.println("Enter metadata about the textbook:");
    System.out.println("Enter title:");
    String title = scanner.next();
    System.out.println("Enter year:");
    int year = readIntInput();
    ...
    publications.add(new Textbook(title, year, pages, language, gradeLevel));
